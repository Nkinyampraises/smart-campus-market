...
const Login = () => {
  ...
  const handleGoogleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      ...
      try {
        // Exchange Google access token for user info, then send to our backend
        ...
        <div className="max-w-[1280px] w-full grid grid-cols-1 lg:grid-cols-2 gap-[80px] bg-white rounded-xl shadow-[0px_4px_20px_rgba(0,0,0,0.04)] overflow-hidden min-h-[700px]">
          ...
          <div className="p-8 md:p-16 flex flex-col justify-center">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              {/* Google Login Button */}
              <button
                className="w-full bg-[#f6f3f2] border border-[#e2bfb2] text-[#1b1c1c] py-3 rounded-lg font-[Manrope] text-[16px] flex items-center justify-center gap-3 hover:bg-[#eae7e7] transition-all active:scale-[0.98] disabled:opacity-60"
                type="button"
