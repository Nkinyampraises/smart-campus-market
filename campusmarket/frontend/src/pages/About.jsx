...
const team = [
  {
    ...
    contributions: ['Design', 'Frontend', 'Testing', 'Jenkins', 'Azure VPS', 'Grafana', 'Prometheus'],
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              { name: 'Prometheus', icon: 'monitoring', color: '#e6522c' },
              { name: 'Redis', icon: 'bolt', color: '#dc382d' },
              { name: 'Jenkins CI', icon: 'construction', color: '#d33832' },
              { name: 'Grafana', icon: 'dashboard', color: '#f46800' },
            ].map((tech) => (
