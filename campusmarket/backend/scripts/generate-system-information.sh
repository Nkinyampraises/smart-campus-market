...
<body><main>
  ...
  <p>Generated by Jenkins at <code>$(html_escape "$generated_at")</code>. Administrative links are served by the VPS Traefik edge.</p>
  <div class="grid">
  ...
  <p><a href="$(html_escape "$public_jenkins_url")">Jenkins</a> · <a href="$(html_escape "$public_grafana_url")">Grafana</a> · <a href="$(html_escape "$public_prometheus_url")">Prometheus</a> · <a href="$(html_escape "$public_sonar_url")">SonarQube</a></p>
</main></body></html>
EOF
